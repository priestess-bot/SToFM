...
from vision_r2_common import _inputs, torch_invoke
from vision_r2_v100_stock_worker import STOCK_STAGES
...
def test_frozen_stock_worker_uses_the_documented_portable_boundaries():
    ...
    marker, mask = torch_invoke("marker_token_embed", tensors)
    ...
    swiglu, no_mask = torch_invoke("swiglu", tensors)
    ...
    layer_norm, no_mask = torch_invoke("residual_layer_norm", tensors)
