...
def _sha256(path: Path) -> str:
    """Hash text artifacts after CRLF-to-LF normalization.

    CSV writers can emit platform line endings while Git stores the tracked
    evidence canonically as LF. The digest therefore identifies the logical
    artifact rather than a checkout-specific line-ending representation.
    """
